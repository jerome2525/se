<?php
//Gravity form list field datepicker
    ...
    class ITSG_GF_List_Field_Date_Picker
    {
		...
		function itsg_gf_ajax_datepicker_function(self){
			...
			jQuery('.gfield_list').each(function() {
				...
				jQuery(this).find('.datepicker').unbind('.datepicker').datepicker({ minDate: 0, dateFormat: 'mm/dd/yy', changeMonth: false}).datepicker('widget').wrap('<div class="ll-skin-nigran"/>');
				jQuery(this).find('.datepicker').datepicker('destroy').datepicker({ minDate: 0, dateFormat: 'mm/dd/yy', changeMonth: false}).datepicker('widget').wrap('<div class="ll-skin-nigran"/>');
				<?php
